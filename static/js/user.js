...
class Simple{
    ...
    global_init(){
        ...
        let UserInfo = "<div class=\"user-info\"><a href=\"" + AdminLink_ + "\"><img src=\"" + UserPic_ + "\" /></a><p><a href=\"" + AdminLink_ + "\">" + UserName_ + "</a></p></div>";
        let HtmlText = ""
    ...
    copyright_init(){
        if (MenuTitle_ === "网站概要"){
            let tmpHtml = '<div class="typecho-page-title"><h2>插件说明</h2></div><div class="row typecho-page-main"><div class="col-mb-12 welcome-board">' +
                '<p><em>SimpleAdmin</em> 是一款即插即用的typecho后台美化插件。建议使用 php7 以上版本。</p>' +
